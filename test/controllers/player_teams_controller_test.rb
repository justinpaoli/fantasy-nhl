...
class PlayerTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_team" do
    assert_difference('PlayerTeam.count') do
      post player_teams_url, params: { player_team: { league_id: @player_team.league_id, name: @player_team.name, roster: @player_team.roster, user_id: @player_team.user_id } }
    end
  ...
  test "should update player_team" do
    patch player_team_url(@player_team), params: { player_team: { league_id: @player_team.league_id, name: @player_team.name, roster: @player_team.roster, user_id: @player_team.user_id } }
