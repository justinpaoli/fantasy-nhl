...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { owner: @league.owner, rules: @league.rules, teamIds: @league.teamIds } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { owner: @league.owner, rules: @league.rules, teamIds: @league.teamIds } }
